...
<body class="bg">
	<div align="right">
		...
		<p align="left"><a href="Modifica"><input type = button value ="Aggiungi Articolo"></a></p>
	</div>	
  ...
  <c:forEach items="${items}" var="articolo">
		<tr>
		    ...
		    <td align ="center"><a href ="Modifica?idArticolo=${articolo.id}"><input type="button" value="Modifica"></a></td>	    
	    </tr>
  </c:forEach>
</table>
<div align="left" style="margin-down: 50px;">
		<p><a href="Modifica"><input type = button value ="Aggiungi Articolo"></a></p>
	</div>	
</body>
</html>